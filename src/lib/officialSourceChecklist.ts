...
export const OFFICIAL_SOURCE_CHECKS: OfficialSourceCheck[] = [
  ...
  // Blok Wykonawczy 3 (Etap F pierwsza fala rozszerzona — patrz
  // docs/EXEC_BLOCK_3_ETAP_E_AUDIT_V1.md dla wyjaśnienia etykiety E/F) — 7
  // dodatkowych, HTTP-zweryfikowanych spółek wodociągowych w Mazowieckiem
  // (rozszerzenie) i Łódzkiem (nowe województwo), ten sam wordpress_rest.
  // Każde źródło osobiście zweryfikowane żywym zapytaniem HTTP (nie
  // zgadywane) przed dodaniem tutaj — patrz docs/EXEC_BLOCK_3_SOURCE_DISCOVERY_V1.md.
  {
    ...
    whatToCheck:
      ...
      "pilotażem, powiat miński, województwo mazowieckie).",
    localities: [],
    frequency: "weekly",
    risk: "low",
    riskNote:
  ...
  },
  {
    ...
    risk: "low",
    riskNote:
      "Poza 6 miejscowościami pilotażu — check-only. Treść bywa mieszana z PR/finansowaniem " +
      "— filtr operacyjności (parseWordpressRestPosts) już to obsługuje.",
  },
  {
    id: "pwik-pultusk",
    name: "PWiK Pułtusk",
    ...
    whatToCheck:
      ...
      "obecnym pilotażem, powiat pułtuski, województwo mazowieckie).",
    localities: [],
    frequency: "weekly",
    risk: "low",
    riskNote:
  ...
  },
  {
    ...
    whatToCheck:
      "Przerwy w dostawie wody, awarie sieci — Miasto Zgierz (poza obecnym pilotażem, " +
      "powiat zgierski, **województwo łódzkie** — pierwsze źródło poza Mazowszem).",
    localities: [],
    frequency: "weekly",
    risk: "low",
    riskNote:
  ...
  },
  {
    ...
    whatToCheck:
      "Przerwy w dostawie wody, awarie sieci — Miasto Pabianice (poza obecnym pilotażem, " +
  ...
  },
  {
    ...
    whatToCheck:
      "Przerwy w dostawie wody, awarie sieci — Gmina Aleksandrów Łódzki (poza obecnym " +
      "pilotażem, powiat zgierski, województwo łódzkie).",
    localities: [],
    frequency: "weekly",
    risk: "low",
    riskNote:
  ...
  },
  {
    ...
    whatToCheck:
      "Przerwy w dostawie wody, awarie sieci — Miasto Rawa Mazowiecka (poza obecnym " +
      "pilotażem, powiat rawski, województwo łódzkie).",
    localities: [],
    frequency: "weekly",
    risk: "low",
    riskNote:

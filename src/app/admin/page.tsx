...
export default function AdminPage() {
  ...
  const stats = [
    { label: "Wszystkie alerty", value: total,          color: "text-slate-900 dark:text-white" },
    { label: "Opublikowane",     value: publishedCount, color: "text-emerald-700 dark:text-emerald-300" },
    { label: "Drafty",           value: draftCount,     color: "text-slate-700 dark:text-slate-300" },
    { label: "Zarchiwizowane",   value: archivedCount,  color: "text-amber-700 dark:text-amber-300" },
  ];
    ...
    <main className="max-w-4xl mx-auto w-full px-4 sm:px-6 py-10">
      ...
      <div className="mb-8">
        <div className="flex flex-wrap items-center gap-2.5 mb-1">
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Panel admina</h1>
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="sm:col-span-2 rounded-2xl border border-blue-200 dark:border-blue-500/30 bg-blue-50 dark:bg-blue-500/15 shadow-sm p-5">
          ...
          {/* 2 — Verify drafts */}
          <div className={`rounded-2xl border shadow-sm p-5 bg-white dark:bg-slate-900 ${draftCount > 0 ? "border-amber-200 dark:border-amber-500/30" : "border-slate-200 dark:border-slate-800"}`}>
          ...
          {/* 3 — Cleanup */}
          <div className={`rounded-2xl border shadow-sm p-5 bg-white dark:bg-slate-900 ${endedPublished.length > 0 ? "border-amber-200 dark:border-amber-500/30" : "border-slate-200 dark:border-slate-800"}`}>
            <h3 className="text-sm font-semibold text-slate-800 dark:text-slate-100 mb-1">
          ...
          <div className="rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-5 bg-white dark:bg-slate-900">
            ...
            <ul className="text-sm text-slate-600 dark:text-slate-400 space-y-1 mb-3">
              <li className="flex items-start gap-2">
                <span className={freshPublishedCount > 0 ? "text-emerald-600" : "text-amber-600 dark:text-amber-300"}>
                  {freshPublishedCount > 0 ? "✓" : "○"}
                </span>
                <span>Świeży alert widoczny publicznie</span>
              </li>
              <li className="flex items-start gap-2">
                <span className={endedPublished.length === 0 ? "text-emerald-600" : "text-amber-600 dark:text-amber-300"}>
                  {endedPublished.length === 0 ? "✓" : "○"}
                </span>
                <span>Stare alerty zarchiwizowane</span>
              </li>
              <li className="flex items-start gap-2">
                <span className={publishedMissingSource.length === 0 ? "text-emerald-600" : "text-amber-600 dark:text-amber-300"}>
          ...
          <div className="sm:col-span-2 rounded-2xl border border-emerald-200 dark:border-emerald-500/30 bg-emerald-50 dark:bg-emerald-500/15 shadow-sm p-5">
            ...
            <div className="flex flex-wrap gap-x-4 gap-y-1">
              <Link
                href="/admin/waste"
                className="text-sm font-medium text-emerald-700 dark:text-emerald-300 hover:text-emerald-900 hover:underline"
              >
          ...
          <div className="sm:col-span-2 rounded-2xl border border-blue-200 dark:border-blue-500/30 bg-white dark:bg-slate-900 shadow-sm p-5">
            <h3 className="text-sm font-semibold text-slate-800 dark:text-slate-100 mb-1">
              6. Sprawdź źródła
            </h3>
            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed mb-3">
            ...
            <Link
              ...
              className="inline-flex items-center gap-1.5 rounded-lg border border-blue-200 dark:border-blue-500/30 bg-blue-50 dark:bg-blue-500/15 px-4 py-2 text-sm font-medium text-blue-700 dark:text-blue-300 hover:bg-blue-100 transition-colors"
            >
              Przejdź do źródeł →
            </Link>
          </div>
          ...
          <div className="sm:col-span-2 rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-sm p-5">
            <h3 className="text-sm font-semibold text-slate-800 dark:text-slate-100 mb-1">
              7. Sprawdź PGE / prąd
            </h3>
            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed mb-3">
          ...
          <div className="sm:col-span-2 rounded-2xl border border-dashed border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/60 p-5">
        ...
        >
          <h2
            className={`text-base font-semibold mb-1 ${
              suspiciousPublished.length > 0 ? "text-red-800" : "text-slate-800 dark:text-slate-100"
            }`}
          >
          ...
          {!alertsLoading && suspiciousPublished.length > 0 ? (
            <>
              <p className="text-sm font-medium text-red-700 dark:text-red-400 mt-2 mb-2">
              ...
              <ul className="text-sm text-red-700 dark:text-red-400 space-y-1 mb-3 list-disc list-inside">
            ...
            <p className="text-sm text-emerald-700 dark:text-emerald-300 font-medium mt-2 mb-3">
          ...
          <details className="border-t border-slate-100 dark:border-slate-800 mt-4 pt-4 group">
            ...
            <ul className="text-sm text-slate-600 dark:text-slate-400 space-y-1.5">
              <li className="flex items-start gap-2">
                <span className={publishedCount >= MIN_RECOMMENDED_ALERTS && publishedCategoryCount >= MIN_RECOMMENDED_CATEGORIES ? "text-emerald-600" : "text-amber-600 dark:text-amber-300"}>
                  {publishedCount >= MIN_RECOMMENDED_ALERTS && publishedCategoryCount >= MIN_RECOMMENDED_CATEGORIES ? "✓" : "○"}
                </span>
                <span>
                  <span className="font-medium text-slate-800 dark:text-slate-100">{publishedCount}</span> opublikowanych
                  alertów w <span className="font-medium text-slate-800 dark:text-slate-100">{publishedCategoryCount}/6</span>{" "}
              ...
              <li className="flex items-start gap-2">
                <span className={sourcesToCheck === 0 ? "text-emerald-600" : "text-amber-600 dark:text-amber-300"}>
                  {sourcesToCheck === 0 ? "✓" : "○"}
                </span>
                <span>
                  {sourcesToCheck === 0
      ...
      <section className="mb-8">
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-5">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400 bg-blue-50 dark:bg-blue-500/15 border border-blue-100 rounded-lg px-3 py-2 mb-4 leading-relaxed">
            ...
            po weryfikacji w{" "}
            <Link href="/builder" className="font-medium text-blue-700 dark:text-blue-300 hover:underline">
              Kreatorze
            </Link>
          ...
          <ol className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {DAILY_WORKFLOW_STEPS.map((step, i) => (
              <li key={step.label} className="flex items-start gap-2.5">
                <span className="shrink-0 w-5 h-5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 text-xs font-semibold flex items-center justify-center mt-0.5">
                  {i + 1}
                </span>
                <div className="min-w-0">
                  {step.href ? (
                    <Link href={step.href} className="text-sm font-medium text-blue-700 dark:text-blue-300 hover:text-blue-900 hover:underline">
                      {step.label}
                    </Link>
                  ) : (
      ...
      {/* ── Alert stats cards ──────────────────────────────────────────── */}
      <section className="mb-8">
        <h2 className="text-base font-semibold text-slate-800 dark:text-slate-100 mb-4">Statystyki alertów</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-4 animate-pulse">
                <div className="h-7 w-10 bg-slate-100 dark:bg-slate-800 rounded mb-2" />
      ...
      <section className="mb-8">
        <h2 className="text-base font-semibold text-slate-800 dark:text-slate-100 mb-4">Wymaga uwagi</h2>
        ...
        {alertsLoading ? (
          ...
          <div
            className={`bg-white dark:bg-slate-900 rounded-2xl border shadow-sm p-5 ${
              draftAlerts.length > 0 ? "border-amber-200 dark:border-amber-500/30" : "border-slate-200 dark:border-slate-800"
            }`}
          >
            ...
            <div className="flex flex-col gap-2.5">
              {draftAlerts.map((a) => (
                <div
                  key={a.id}
                  className="flex flex-wrap items-center justify-between gap-2 border-t border-slate-100 dark:border-slate-800 pt-2.5 first:border-0 first:pt-0"
                >
                  <div className="min-w-0">
                  ...
                  <Link
                    href={`/builder?edit=${a.slug}`}
                    className="shrink-0 rounded-lg border border-amber-200 dark:border-amber-500/30 bg-amber-50 dark:bg-amber-500/15 px-3 py-1.5 text-sm font-medium text-amber-700 dark:text-amber-300 hover:bg-amber-100 transition-colors"
                  >
                    Dokończ w kreatorze
                  </Link>
                </div>
      ...
      {/* ── Sources to check ──────────────────────────────────────────── */}
      <section className="mb-8">
        <h2 className="text-base font-semibold text-slate-800 dark:text-slate-100 mb-4">Źródła do sprawdzenia</h2>
        ...
        {sourcesLoading ? (
          ...
          <div
            className={`bg-white dark:bg-slate-900 rounded-2xl border shadow-sm p-5 ${
              sourcesToCheck > 0 ? "border-amber-200 dark:border-amber-500/30" : "border-slate-200 dark:border-slate-800"
            }`}
          >
            {/* Count row */}
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-0">
              <div className="flex-1">
                <p
                  className={`text-3xl font-bold ${
                    sourcesToCheck > 0 ? "text-amber-600 dark:text-amber-300" : "text-emerald-600"
                  }`}
                >
                  {sourcesToCheck}
                </p>
              ...
              <Link
                href="/admin/sources"
                className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/60 hover:border-slate-300 transition-colors shrink-0"
              >
                Przejdź do źródeł →
              </Link>
            </div>
              ...
              <>
                ...
                <div className="flex flex-col gap-2">
                  {recentChecks.map((check) => {
                    const cfg = CHECK_RESULT_LABELS[check.result] ?? { label: check.result, color: "text-slate-600 dark:text-slate-400" };
                    return (
                      <div key={check.id} className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5 text-sm">
                        ...
                        {check.notes && (
                          <span className="text-xs text-slate-500 dark:text-slate-400 truncate">— {check.notes}</span>
                        )}
                      </div>
                    );
                  })}
      ...
      <section className="mb-8">
        ...
        {sourcesLoading ? (
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5 animate-pulse">
            <div className="h-8 w-12 bg-slate-100 dark:bg-slate-800 rounded mb-2" />
            <div className="h-3 w-48 bg-slate-100 dark:bg-slate-800 rounded" />
          </div>
        ) : (
          <div
          ...
          >
            ...
            <div className="flex flex-col items-start gap-1.5 shrink-0">
              <Link
                href="/admin/queue"
                className="inline-flex items-center gap-1.5 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800/60 hover:border-slate-300 transition-colors"
              >
                Otwórz kolejkę →
              </Link>
        ...
        {!sourcesLoading && persistentNotices === null && (
          <div className="mt-3 bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
              ...
              <Link href="/admin/queue" className="font-medium text-blue-600 dark:text-blue-400 hover:underline">
                Kandydatach
              </Link>.
            </p>
          </div>
        ...
        {!sourcesLoading && persistentNotices && (
          <div className="mt-3 bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-200 dark:border-slate-800 p-5">
            ...
            {(() => {
              ...
              return (
                <div className="space-y-1.5">
                  {recent.map((n) => (
                    <p key={n.id} className="text-xs text-slate-600 dark:text-slate-400 truncate">
      ...
      <section className="mb-8">
        ...
        {sourcesLoading ? (
          <div className="flex flex-col gap-2">
            {[1, 2].map((i) => (
              <div key={i} className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4 animate-pulse h-16" />
            ))}
          </div>
        ) : activeSources.length === 0 ? (
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5">
            <p className="text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Brak aktywnych źródeł.</p>
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
            ...
            {[...activeSources]
              ...
              .map((s) => {
                ...
                return (
                  <div
                    key={s.id}
                    className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-3.5 flex flex-wrap items-center justify-between gap-3"
                  >
                    <div className="min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 shrink-0 flex-wrap">
                      <Link
                        href="/admin/sources"
                        className="rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-2.5 py-1.5 text-xs font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800/60 transition-colors"
                      >
                        Sprawdź źródło →
                      </Link>
                      {candidateCount > 0 && (
                      ...
                      <Link
                        href="/builder"
                        className="rounded-lg border border-amber-200 dark:border-amber-500/30 bg-amber-50 dark:bg-amber-500/15 px-2.5 py-1.5 text-xs font-medium text-amber-700 dark:text-amber-300 hover:bg-amber-100 transition-colors"
                      >
                        Kreator →
                      </Link>
                    </div>
      ...
      <section className="mb-8">
        <h2 className="text-base font-semibold text-slate-800 dark:text-slate-100 mb-4">Harmonogram odpadów</h2>
        ...
        {sourcesLoading ? (
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-5">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
              ...
              <Link href="/odpady" className="font-medium text-blue-600 dark:text-blue-400 hover:underline">
                Zobacz publiczną stronę „Odpady" →
              </Link>
            </p>
          </div>
        ) : (
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm p-5 flex flex-col sm:flex-row sm:items-center gap-4">
            <div className="flex-1">
              <p className={`text-3xl font-bold ${wasteScheduleCount === 0 ? "text-amber-600 dark:text-amber-300" : "text-emerald-600"}`}>
                {wasteScheduleCount}
              </p>
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-1 leading-snug">
                {wasteScheduleCount === 0
            ...
            <div className="flex items-center gap-2 shrink-0 flex-wrap">
              <Link
                href="/admin/waste"
                className="inline-flex items-center gap-1.5 rounded-lg bg-blue-600 dark:bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 dark:hover:bg-blue-400 transition-colors"
              >
                Zarządzaj terminami →
              </Link>
              <Link
      ...
      <section className="mb-10">
        <h2 className="text-base font-semibold text-slate-800 dark:text-slate-100 mb-4">Ostatnio zmienione alerty</h2>
      ...
      {/* ── Quick actions ──────────────────────────────────────────────── */}
      <section>
        <h2 className="text-base font-semibold text-slate-800 dark:text-slate-100 mb-4">Szybkie akcje</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {quickActions.map((action) => (
            <Link
              key={action.href}
              href={action.href}
              className={`bg-white dark:bg-slate-900 rounded-2xl border shadow-sm p-5 flex flex-col gap-1.5 transition-all hover:shadow-md ${action.border}`}
            >
              ...
              <p className="text-xs font-medium text-blue-600 dark:text-blue-400 mt-1">Przejdź →</p>
            </Link>
          ))}
        </div>
      </section>
      ...
      <section className="mt-8">
        <div className="bg-slate-50 dark:bg-slate-800/60 rounded-2xl border border-slate-200 dark:border-slate-800 p-5">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-3 leading-relaxed">
            ...
            <Link href="/about" className="font-medium text-blue-600 dark:text-blue-400 hover:underline">
              O projekcie
            </Link>

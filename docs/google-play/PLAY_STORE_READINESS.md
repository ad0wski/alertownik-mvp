...
## 4. Checklista zasobów graficznych

| Zasób | Ścieżka / status |
|---|---|
| Ikona aplikacji 512×512 | `assets/store/play-icon-512.png` — istnieje w repo |
| Grafika promocyjna 1024×500 | `assets/store/feature-graphic-1024x500.png` — istnieje w repo |
| Screenshoty telefonu (min. 2) | **nadal do wykonania** — brak w repo celowo (patrz `assets/store/README.md`) |
...
## 5. Matryca deklaracji — materiał roboczy, NIE gotowa deklaracja prawna
...
## 6. Checklista deklaracji Play Console
...
- [ ] Dane kontaktowe karty aplikacji (adres e-mail, opcjonalnie strona/telefon)
- [ ] Oświadczenie o braku oficjalnego powiązania z urzędami/instytucjami

---

## 7. Plan zamkniętego testu (closed testing)
...
## 8. Tekst zaproszenia dla testerów (bez linku)
...
## 9. Rejestr testerów — uwaga o poufności
...
1. Ostateczna treść pełnego opisu przed wklejeniem do Play Console.
2. Ostateczny wybór kategorii z zamkniętej listy Play Console.
3. Wizualne zatwierdzenie ikony, grafiki promocyjnej i screenshotów przed przesłaniem.
4. Wykonanie brakujących screenshotów telefonu.
5. Decyzja co do uprawnienia `POST_NOTIFICATIONS` przed finalnym wydaniem.
6. Potwierdzenie zakresu przetwarzania danych przez Vercel/Supabase przed zatwierdzeniem Data safety.
7. Końcowa rewizja `/prywatnosc` przed publiczną publikacją w sklepie.
8. Wypełnienie i zatwierdzenie wszystkich formularzy z sekcji 6 bezpośrednio w Play Console (poza zakresem tego dokumentu).
